...
**Tailored Output.** Deploy the abilty for end users to customize and tailor outputs of the assessment (e.g., Regulatory Timeline, MDR and/or IVDR, Area, Detailed Evidence Requirements). End users can be (i) Consultants, (ii) Med Techs OEM; (iii) ODMS
